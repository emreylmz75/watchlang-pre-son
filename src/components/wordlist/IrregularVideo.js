...
import PostSingle from "./IrregularVideoDetail";
...
export default function IrregularVideo() {
   ...
   /*  if(words.word==undefined){
    ...
    const getMoreData =  () => {
       ...
       console.log(words.first,"dsadsasdaasd")
    ...
    const getMoreDataChange =  (textChange) => {
        ...
        return (
            ...
            >
                ...
                />
                 ...
                 style={{display:"flex",flexDirection:"row",justifyContent:"space-around",position:"absolute",top:70,width:"100%"}}>
                 <TouchableOpacity 
                 onPress={() => getMoreDataChange(words.first)}
                 style={{marginRight:5,paddingHorizontal:30,paddingVertical:8,borderRadius:5,backgroundColor:"white"}}>
                <Text style={{}}>{words.first}</Text>
                </TouchableOpacity>
                 
                 <TouchableOpacity style={{marginRight:5,paddingHorizontal:30,paddingVertical:8,borderRadius:5,backgroundColor:"white"}}>
                <Text 
                onPress={() => getMoreDataChange(words.second)}
                style={{}}>{words.second}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                onPress={() => getMoreDataChange(words.third)}
                style={{paddingHorizontal:30,paddingVertical:8,borderRadius:5,backgroundColor:"white"}}>
                <Text style={{}}>{words.third}</Text>
                </TouchableOpacity>
                 </View>
            </View>
        );
