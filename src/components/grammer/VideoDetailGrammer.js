...
export const VideoDetailGrammer = forwardRef(
    (
        {
            item,
            showText,
        ...
        /* useEffect(()=>{
            url2="https://aws-joygoy-s3.s3.eu-central-1.amazonaws.com/" +item?.number +".mp4";
            setSource("https://aws-joygoy-s3.s3.eu-central-1.amazonaws.com/" +item?.number +".mp4")
        ...
        return (
            ...
            />
                           ...
                           <Video
                            ...
                            ref={ref}
                            source={{
                                uri:"https://aws-joygoy-s3.s3.eu-central-1.amazonaws.com/" +item?.number +".mp4"
                            }}
                            resizeMode="cover"
...
export default VideoDetailGrammer;
